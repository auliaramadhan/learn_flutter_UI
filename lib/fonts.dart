...
class Fonts {
  ...
  // static const titleMedium = TextStyle(fontSize: 16, fontWeight: FontWeight.w400, letterSpacing: 0.15);
  ...
  // static const labelLarge = TextStyle(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.4);
